...
\input{chapters/experimental_reactor_kinetics/01-intro_control_rods.tex}
\input{chapters/experimental_reactor_kinetics/02-critical_calibration.tex}
\input{chapters/experimental_reactor_kinetics/03-subcritical_calibration.tex}
\input{chapters/experimental_reactor_kinetics/04-reactivity_coefficients}
\input{chapters/experimental_reactor_kinetics/05-pulse_mode}
\input{chapters/experimental_reactor_kinetics/06-thermal_hydraulics}
\input{chapters/experimental_reactor_kinetics/07-montecarlo.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
