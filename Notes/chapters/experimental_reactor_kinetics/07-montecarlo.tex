...
Serpent uses \textit{delta-tracking}: all the sampling is done with the same cross section: $\Sigma_M$ called Majorant such that $\Simga_m = \Sigma_{tot, i} + \Sigma_{virtual, i}$
