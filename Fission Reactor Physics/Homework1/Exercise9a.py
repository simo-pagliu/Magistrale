...
volume = mass_U / density_U

# neutron flux
Sigma_fiss_U = nf.macro(sigma_f/(10e-24), 19, 235)
flux = fission_rate / (Sigma_fiss_U * volume)
print("Flux", flux)
...
eq_Nd = sp.Eq(sp.diff(Nd,t), sigma_f * flux * Ur * branching_ratio_Nd - decay_Nd * Nd)
