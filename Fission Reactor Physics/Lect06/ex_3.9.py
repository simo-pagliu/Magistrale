...
#It is possible to define the source term as a function of time, comment out the previous line and uncomment the following line, you then also have to define an expression
